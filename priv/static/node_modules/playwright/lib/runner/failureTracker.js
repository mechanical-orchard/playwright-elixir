...
class FailureTracker {
  ...
  result() {
    ...
    return this._hasWorkerErrors || this.hasReachedMaxFailures() || (_this$_rootSuite = this._rootSuite) !== null && _this$_rootSuite !== void 0 && _this$_rootSuite.allTests().some(test => !test.ok()) ? 'failed' : 'passed';
  }
}
